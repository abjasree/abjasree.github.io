...
(async function loadProjects() {
  ...
  try {
    ...
    const res = await fetch(
      "https://api.github.com/users/abjasree/repos?per_page=100&sort=updated",
      {
    ...
    grid.innerHTML =
      ...
      `<a href="https://github.com/abjasree" target="_blank" ` +
      `rel="noreferrer">github.com/abjasree</a>.</p>`;
  }
})();